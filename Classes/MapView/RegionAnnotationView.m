...
- (void)layoutSubviews{
    ...
    self.canShowCallout = NO;
    if (regionAnnotaytion.annotationType == RegionChoose){
...
-(void)initUI{
    ...
    self.bgImgView.image = [[UIImage imageNamed:@"MapView.bundle/wl_map_icon_5.png"] stretchableImageWithLeftCapWidth:28 topCapHeight:16];
...
-(void)addConner:(CGRect)rect{
    ...
    connerView.image = [UIImage imageNamed:@"MapView.bundle/wl_map_icon_4.png"];
...
-(void)addCenter:(CGRect)anFrame{
    ...
    locImg.image = [UIImage imageNamed:@"MapView.bundle/anjuke_icon_itis_position.png"];
